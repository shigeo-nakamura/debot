...
use crate::{
    addresses::{
        BSC_BISWAP_ROUTER, BSC_BTCB_ADDRESS, BSC_CAKE_ADDRESS, BSC_ETH_ADDRESS,
        BSC_MAINNET_CHAIN_ID, BSC_PANCAKESWAP_ROUTER, BSC_TESTNET_CHAIN_ID, BSC_USDT_ADDRESS,
        BSC_WBNB_ADDRESS, POLYGON_MAINNET_CHAIN_ID, POLYGON_MESHSWAP_ROUTER,
        POLYGON_QUICKSWAP_ROUTER, POLYGON_SUSHISWAP_ROUTER, POLYGON_TESTNET_CHAIN_ID,
        POLYGON_USDC_ADDRESS, POLYGON_WBTC_ADDRESS, POLYGON_WETH_ADDRESS, POLYGON_WMATIC_ADDRESS,
...
lazy_static! {
    ...
    pub static ref POLYGON_CHAIN_PARAMS: ChainParams = ChainParams {
        ...
        tokens: &[
            ...
            ("BTC", POLYGON_WBTC_ADDRESS),
            ("ETH", POLYGON_WETH_ADDRESS),
            // ("DAI", POLYGON_DAI_ADDRESS),
            // ("MAI", POLYGON_MAI_ADDRESS),
            ("MATIC", POLYGON_WMATIC_ADDRESS),
