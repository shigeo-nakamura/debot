...
impl DerivativeTrader {
    pub async fn new(
        ...
        let mut config = DerivativeTraderConfig {
            ...
            dry_run,
            short_trade_period: sample_interval.short_term * SECONDS_IN_MINUTE / interval_secs as usize,
            long_trade_period: sample_interval.long_term * SECONDS_IN_MINUTE / interval_secs as usize,
            trade_period: trade_interval * SECONDS_IN_MINUTE / interval_secs as usize,
            execution_period: execution_interval.unwrap_or_default() * SECONDS_IN_MINUTE / interval_secs as usize,
            interval_secs,
