        ...
        if let Some(db) = self.transaction_log.get_w_db().await {
            let position_log = PositionLog {
                ...
                debug: DebugLog {
                    ...
                    input_24: position.candle_pattern()[4],
                    input_25: position.candle_pattern()[5],
                    input_26: position.candle_pattern()[6],
                    input_27: position.candle_pattern()[7],
                    input_28: position.candle_pattern()[8],
                    input_29: position.candle_pattern()[9],
                    input_30: position.candle_pattern()[10],
                    input_31: position.candle_pattern()[11],
                    input_32: position.candle_pattern()[12],
                    input_33: position.candle_pattern()[13],
                    input_34: position.candle_pattern()[14],
                    input_35: position.candle_pattern()[15],
                    input_36: Decimal::ZERO,
                    input_37: Decimal::ZERO,
                    input_38: Decimal::ZERO,
                    input_39: Decimal::ZERO,
                    input_40: Decimal::ZERO,
