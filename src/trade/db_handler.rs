        ...
        if let Some(db) = self.transaction_log.get_db().await {
            let position_log = PositionLog {
                ...
                debug: DebugLog {
                    ...
                    input_4: position.atr().3.round_dp(4),
                    input_5: position.atr().4.round_dp(4),
                    input_6: position.atr().5.round_dp(4),
                    input_7: position.adx().3.round_dp(4),
                    input_8: position.adx().4.round_dp(4),
                    input_9: position.adx().5.round_dp(4),
                    input_10: position.rsi().3.round_dp(4),
                    input_11: position.rsi().4.round_dp(4),
                    input_12: position.rsi().5.round_dp(4),
                    input_13: position.stochastic().3.round_dp(4),
                    input_14: position.stochastic().4.round_dp(4),
                    input_15: position.stochastic().5.round_dp(4),
