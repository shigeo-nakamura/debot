        ...
        if let Some(db) = self.transaction_log.get_w_db().await {
            let position_log = PositionLog {
                ...
                debug: DebugLog {
                    ...
                    input_22: position.candle_pattern().0[2],
                    input_23: position.candle_pattern().0[3],
                    input_24: position.candle_pattern().0[4],
                    input_25: position.candle_pattern().0[5],
                    input_26: position.candle_pattern().0[6],
                    input_27: position.candle_pattern().0[7],
                    input_28: position.candle_pattern().0[8],
                    input_29: position.candle_pattern().0[9],
                    input_30: position.candle_pattern().0[10],
                    input_31: position.candle_pattern().0[11],
                    input_32: position.candle_pattern().0[12],
                    input_33: position.candle_pattern().0[13],
                    input_34: position.candle_pattern().0[14],
                    input_35: position.candle_pattern().0[15],
                    input_36: Decimal::ZERO,
                    input_37: Decimal::ZERO,
                    input_38: Decimal::ZERO,
                    input_39: Decimal::ZERO,
                    input_40: position.candle_pattern().1[0],
                    input_41: position.candle_pattern().1[1],
                    input_42: position.candle_pattern().1[2],
                    input_43: position.candle_pattern().1[3],
                    input_44: position.candle_pattern().1[4],
                    input_45: position.candle_pattern().1[5],
                    input_46: position.candle_pattern().1[6],
                    input_47: position.candle_pattern().1[7],
                    input_48: position.candle_pattern().1[8],
                    input_49: position.candle_pattern().1[9],
                    input_50: position.candle_pattern().1[10],
                    input_51: position.candle_pattern().1[11],
                    input_52: position.candle_pattern().1[12],
                    input_53: position.candle_pattern().1[13],
                    input_54: position.candle_pattern().1[14],
                    input_55: position.candle_pattern().1[15],
                    input_56: Decimal::ZERO,
                    input_57: Decimal::ZERO,
                    input_58: Decimal::ZERO,
                    input_59: Decimal::ZERO,
